...
void RosPythonInterpreter::start_ros_service()
{
...
bool RosPythonInterpreter::runCommandCallback(
...
bool RosPythonInterpreter::runPythonFileCallback(
...
void RosPythonInterpreter::run_python_command(const std::string& command,
                                              std::string& result,
                                              std::string& out,
                                              std::string& err)
{
