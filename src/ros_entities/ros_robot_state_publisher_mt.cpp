...
RosRobotStatePublisherMt::RosRobotStatePublisherMt( const std::string& name ):
  Entity( name ),
  trigger_signal_ (boost::bind (&RosRobotStatePublisherMt::trigger, this, _1, _2),
                                 ...
                                 const std::string& joint_state_topic_name)
{
    ...
    pub.callback_function_ = boost::bind(
      &RosRobotStatePublisherMt::copy_data_internally, this,
    ...
    pub.thread_ = std::thread(&RosRobotStatePublisherMt::send_data, this,
